...
contains
   ...
   subroutine oslo_aero_diagnostics_init()
      ...
      if (use_aerocom) then
         ...
         call addfld ('EC440R40',(/'lev'/), 'A','m-1     ','Aerosol extinction at 440nm at RH=40%')
         call addfld ('EC550R40',(/'lev'/), 'A','m-1     ','Aerosol extinction at 550nm at RH=40%')
         call addfld ('EC870R40',(/'lev'/), 'A','m-1     ','Aerosol extinction at 870nm at RH=40%')
         call addfld ('ABS440R40',(/'lev'/), 'A','m-1     ','Aerosol absorption at 440nm at RH=40%')
         call addfld ('ABS550R40',(/'lev'/), 'A','m-1     ','Aerosol absorption at 550nm at RH=40%')
         call addfld ('ABS870R40',(/'lev'/), 'A','m-1     ','Aerosol absorption at 870nm at RH=40%')
         call addfld ('EC440R85',(/'lev'/), 'A','m-1     ','Aerosol extinction at 440nm at RH=85%')
         call addfld ('EC550R85',(/'lev'/), 'A','m-1     ','Aerosol extinction at 550nm at RH=85%')
         call addfld ('EC870R85',(/'lev'/), 'A','m-1     ','Aerosol extinction at 870nm at RH=85%')
         call addfld ('ABS440R85',(/'lev'/), 'A','m-1     ','Aerosol absorption at 440nm at RH=85%')
         call addfld ('ABS550R85',(/'lev'/), 'A','m-1     ','Aerosol absorption at 550nm at RH=85%')
         call addfld ('ABS870R85',(/'lev'/), 'A','m-1     ','Aerosol absorption at 870nm at RH=85%')
         ...
         call addfld ('ABS10UM '  ,horiz_only, 'A','unitless','Aerosol absorption optical depth ~10um (9.26-10.20um LW band)')
         call addfld ('A10UM_DU'  ,horiz_only, 'A','unitless','Mineral/dust absorption optical depth ~10um (9.26-10.20um LW band)')
         ...
         call add_default ('EC440R40', 1, ' ')
         call add_default ('EC550R40', 1, ' ')
         call add_default ('EC870R40', 1, ' ')
         call add_default ('ABS440R40', 1, ' ')
         call add_default ('ABS550R40', 1, ' ')
         call add_default ('ABS870R40', 1, ' ')
         call add_default ('EC440R85', 1, ' ')
         call add_default ('EC550R85', 1, ' ')
         call add_default ('EC870R85', 1, ' ')
         call add_default ('ABS440R85', 1, ' ')
         call add_default ('ABS550R85', 1, ' ')
         call add_default ('ABS870R85', 1, ' ')
         ...
         call add_default ('ABS10UM ', 1, ' ')
         call add_default ('A10UM_DU', 1, ' ')
